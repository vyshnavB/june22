...
def profile(request, username):
    ...
    if invite_request.objects.filter(from_user=us):
    ...
    elif    invite_request.objects.filter(to_user=us):
...
def intrest_create(request):
    if request.method == 'POST':
        ...
        if parent != "":
            ...
            intrest4 = intrest.objects.get(id=parent)

            intrest_create.parent = intrest4
            intrest_create.save()
